...
const NavBar = () => {
    ...
    return(
        ...
        <div className="card-header"></div>
            <div name="big-nav-container" className="big-nav-container hidden lg:block border-b-2 border-gray-500">
            ...
            <div name="nav-logo-container" className="bg-black lg:col-span-1 m-2 col-span-6 h-20 lg:h-auto">
                <img style={{height:"90px", width: "100%"}} src="./assets/images/BrandLogo.png"/>
            </div>
            ...
            <div name="nav-right-container" className="lg:col-span-1 col-span-6 h-10 grid grid-cols-2 lg:h-auto">
                <div className="flex justify-center items-center">                    
                <a href="#">
                    <img style={{height: "40px"}}  src="./assets/icons/iconCart.png"></img>
                    
                </a>
                </div>
                <div className="flex justify-center items-center">
                    <a href="#" style={{ textDecoration: "none" }}>
                    <img style={{height: "20px"}}  src="./assets/icons/iconLogout.png"></img>
                    </a>
                </div>
            ...
            <div name="small-nav-container" className="lg:hidden block shadow-lg bg-gray-100">
                ...
                <div className="h-15 grid grid-cols-8">
                    ...
                    <a href="#" className="col-span-3 flex justify-center items-center" onClick={() => setMenuIsOpen(!menuIsOpen)} style={{ textDecoration: "none" }}>
                        {menuIsOpen ? 
                    ...
                    <img style={{height:"40px", width: "auto"}} src="./assets/images/BrandLogo.png"/>
                    </div>
                ...
                {menuIsOpen ?
                    <div name="hidden-small-nav" className="grid grid-rows-9 justify-center">
                        ...
                        <a href="#" className="text-left text-lg my-auto">PC's</a>
                        <a href="#" className="text-left text-lg my-auto">Laptops</a>
                        <a href="#" className="text-left text-lg my-auto">Monitor</a>
                        <a href="#" className="text-left text-lg my-auto">Peripherals</a>
                        <a href="#" className="text-left text-lg my-auto">Software</a>
                        <div className="border-t my-2 border-gray-500"></div>
