const CartItemPreview = ({imageLink, brandName, itemName, price, quantity}) => {
    return(
        <div className="cart-item-preview grid lg:grid-cols-6 grid-cols-3 grid-rows-2 lg:grid-rows-1 lg:my-3 my-0 cart-item-preview-shadow">
            <div className="h-20 col-span-1 grid grid-cols-3">
                <div className="flex items-center justify-center lg:mr-5 mr-0">
                <a href="#">
                    <img style={{maxHeight:"22px"}} src="./assets/icons/iconDelete.png" className="flex items-center justify-center md:mx-2 mx-0 lg:col-span-1 col-span-3"></img>
                    </a>
                </div>
            ...
            <div className="h-20 col-span-2 grid place-content-center place-items-center">
                ...
                <a className="color-clickable cart-item-name-link hover:scale-105 ease-in-out transition-all" href="#" target="_blank"><h1>{brandName} - {itemName}</h1></a>
            </div>
