/* Biolerplate data to fill the database */
const items = [
  {
    ...
    description:
      "Experience lightning-fast computing with the SuperSpeed PC from ACME Technologies. Powered by the latest generation processors and cutting-edge technology, this PC delivers unparalleled speed and performance for all your computing needs. Whether you're a gamer, content creator, or professional, the SuperSpeed PC handles resource-intensive tasks effortlessly, providing a seamless and responsive user experience. With its sleek design and powerful internals, it's time to take your computing to new heights with the SuperSpeed PC.",
    price: 2499.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Unlock your professional potential with the MaxCompute Pro Workstation. Engineered for power and productivity, this workstation is a force to be reckoned with. Featuring high-performance components and advanced multi-threading capabilities, it tackles resource-intensive tasks such as video editing, 3D rendering, and data analysis with ease. The Pro Workstation offers a seamless workflow, enabling you to handle complex projects efficiently. With its robust build quality and reliable performance, the MaxCompute Pro Workstation empowers professionals to push their boundaries and achieve exceptional results.",
    price: 1999.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Unleash extreme power with the MegaByte Extreme Overclocked PC. Engineered for maximum performance, this PC is equipped with top-of-the-line components and an advanced liquid cooling system to push the boundaries of overclocking. Whether you're an overclocking enthusiast or a professional requiring lightning-fast processing, the Extreme Overclocked PC delivers unrivaled speed and responsiveness. Dominate the competition, render projects in record time, and experience seamless multitasking with this powerhouse. Elevate your computing experience with the MegaByte Extreme Overclocked PC.",
    price: 3999.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Simplify your workspace with the TechMakers All-in-One PC. Combining a sleek design with powerful performance, this PC integrates the monitor and components into a single unit, reducing clutter and providing a seamless user experience. Whether you need it for work, entertainment, or everyday tasks, the All-in-One PC offers convenience and functionality. Enjoy vibrant visuals, responsive touchscreens, and easy setup with this all-inclusive solution. Upgrade your workspace with the TechMakers All-in-One PC.",
    price: 1699.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Expand your horizons with the UltraTech Multi-Monitor PC. Designed for productivity and immersive experiences, this PC supports multiple monitors for enhanced multitasking, gaming, and content creation. With its powerful graphics capabilities and high-speed connectivity, it offers seamless transitions between screens and delivers exceptional visuals. Boost your productivity, create expansive gaming setups, or immerse yourself in a panoramic viewing experience with the UltraTech Multi-Monitor PC.",
    price: 2199.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Experience gaming on-the-go with the SwiftByte Compact Gaming PC. Designed for portability without sacrificing performance, this PC delivers powerful gaming experiences in a compact form factor. Equipped with high-performance components and efficient cooling systems, it handles demanding games with ease. Whether you're traveling, attending LAN parties, or looking for a space-saving solution, the Compact Gaming PC offers the perfect balance of power and portability. Elevate your gaming wherever you go with the SwiftByte Compact Gaming PC.",
    price: 1499.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Achieve unparalleled productivity with the MegaByte Powerhouse Workstation. Built to handle demanding workloads and complex tasks, this workstation offers exceptional processing power, extensive storage options, and professional-grade graphics. Whether you're a designer, engineer, or data analyst, the Powerhouse Workstation provides the performance and reliability you need to excel. From 3D modeling to scientific simulations, this workstation is your trusted partner in tackling challenging projects. Maximize your productivity with the MegaByte Powerhouse Workstation.",
    price: 3299.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Combine style and performance with the UltraTech Sleek Gaming PC. Designed with a sleek and modern aesthetic, this PC stands out while delivering powerful gaming experiences. Equipped with high-performance components and advanced cooling systems, it handles the latest games with ease. Immerse yourself in stunning visuals, responsive controls, and immersive audio. The Sleek Gaming PC is the perfect choice for gamers who demand both power and aesthetics. Level up your gaming setup with the UltraTech Sleek Gaming PC.",
    price: 2199.99,
    category: "pc",
    specs: {
  ...
  },
  {
    ...
    description:
      "Take your gaming on the go with the MegaSpeed Gaming Laptop. Packed with high-performance components and dedicated graphics, it delivers desktop-level gaming experiences in a portable form factor. Whether you're playing the latest AAA titles or tackling demanding tasks, the Gaming Laptop offers smooth gameplay and exceptional visuals. With its ergonomic design and immersive audio, it's the perfect companion for gaming enthusiasts. Unleash your gaming potential with the MegaSpeed Gaming Laptop.",
    price: 1999.99,
    specs: {
  ...
  },
  {
    ...
    description:
      "Stay ahead in the business world with the TechGenius Powerful Business Laptop. Designed for professionals who demand both power and security, this laptop combines high-performance components with advanced security features. With its durable build, long battery life, and comprehensive connectivity options, it's the perfect companion for business travelers. The Powerful Business Laptop ensures productivity and peace of mind, allowing you to focus on your work without compromise.",
    price: 1799.99,
    specs: {
  ...
  },
  {
    ...
    description:
      "Experience reliable performance without breaking the bank with the SwiftByte Budget-Friendly Laptop. Designed for everyday computing tasks, this laptop offers a balance of affordability and functionality. Whether you're browsing the web, working on documents, or enjoying multimedia content, it delivers smooth and responsive performance. With its compact design and long battery life, it's the ideal choice for students and casual users. Get the job done without compromising your budget with the SwiftByte Budget-Friendly Laptop.",
    price: 899.99,
    specs: {
  ...
  },
  {
    ...
    description:
      "Experience unparalleled performance with the GigaSpeed High-Performance Laptop. Packed with cutting-edge hardware and powerful graphics, it handles resource-intensive tasks with ease. Whether you're editing videos, running virtual machines, or designing complex models, the High-Performance Laptop delivers exceptional speed and responsiveness. With its stunning display and immersive audio, it's the perfect choice for content creators and power users. Take your productivity to new heights with the GigaSpeed High-Performance Laptop.",
    price: 2799.99,
    specs: {
  ...
  },
  {
    ...
    description:
      "Unleash your creativity and gaming prowess with the UltraTech Gaming & Design Laptop. Featuring high-performance components and dedicated graphics, it handles demanding games and resource-intensive design tasks with ease. With its high-refresh-rate display and color accuracy, it brings your visuals to life with stunning clarity. The Gaming & Design Laptop combines power, versatility, and style, making it the perfect choice for creative professionals and avid gamers.",
    price: 2199.99,
    specs: {
  ...
  },
  {
    ...
    description:
      "Maximize your productivity with the MegaByte High-End Workstation Laptop. Built for professionals who require uncompromising performance, this laptop offers powerful hardware and extensive storage options. From complex simulations to rendering projects, it delivers exceptional speed and efficiency. With its color-accurate display and comprehensive connectivity, it's the ultimate workstation on the go. Elevate your productivity with the MegaByte High-End Workstation Laptop.",
    price: 2999.99,
    specs: {
      CPU: "MegaByte Xeon",
  ...
  },
  {
    ...
    description:
      "Experience the perfect blend of style and performance with the TechVision Premium Ultrabook. Featuring a sleek and lightweight design, it's ideal for professionals on the move. With its powerful hardware and long battery life, it delivers exceptional performance and productivity. The Premium Ultrabook offers a stunning display, fast storage, and comprehensive connectivity options. Elevate your mobile computing experience with the TechVision Premium Ultrabook.",
    price: 1799.99,
    specs: {
  ...
  },
  {
    ...
    descriptionHeader:
      "Immersive and comfortable viewing with a curved display.",
    description:
  ...
  },
  {
    ...
    description:
      "Unleash your creativity with the MaxView Professional Monitor. Designed for professionals who demand color accuracy and precise detail, it delivers exceptional visual quality for graphic design, photo editing, and other professional tasks. With its high-resolution display and wide color gamut, it faithfully reproduces colors with stunning accuracy. The Professional Monitor offers a range of customization options to fine-tune your workflow. Take your professional work to the next level with the MaxView Professional Monitor.",
    price: 1499.99,
    specs: {
      Resolution: "3840x2160",
      Size: 27,
  ...
  },
  {
    ...
    description:
      "Immerse yourself in expansive visuals with the GigaScreen Large-Sized Monitor. With its generous screen size and high-resolution display, it offers an immersive and engaging viewing experience. Whether you're watching movies, playing games, or working on large-scale projects, the Large-Sized Monitor provides ample space and crisp details. With its sleek design and comprehensive connectivity options, it's the perfect choice for multimedia enthusiasts and professionals seeking a spacious workspace. Elevate your visual experiences with the GigaScreen Large-Sized Monitor.",
    price: 1499.99,
    specs: {
      Resolution: "3840x2160",
      Size: 43,
  ...
  },
  {
    ...
    description:
      "Achieve precise color accuracy and detail with the TechPro Professional Studio Monitor. Designed for photographers, graphic designers, and video editors, it offers exceptional color reproduction and image clarity. The Professional Studio Monitor's wide color gamut and hardware calibration support ensure accurate and consistent results for your studio work. With its high-resolution display and ergonomic stand, it provides a comfortable and efficient workflow. Elevate your studio work with the TechPro Professional Studio Monitor.",
    price: 1799.99,
    specs: {
      resolution: "3840x2160",
      size: 27,
  ...
  },
  {
    ...
    descriptionHeader:
      "Immerse Yourself in Rich Audio with Over-Ear Headphones",
    description:
  ...
  },
  {
    ...
    descriptionHeader:
      "Enhance Your Gaming Performance with Mechanical Keyboard",
    description:
  ...
  },
  {
    ...
    descriptionHeader:
      "Immerse Yourself in Music with Noise-Canceling Headphones",
    description:
  ...
  },
  {
    ...
    descriptionHeader:
      "Enhance Your Gaming Experience with Mechanical Keyboard",
    description:
  ...
  },
  {
    ...
    descriptionHeader:
      "Effortless and Comfortable Navigation with Wireless Mouse",
    description:
  ...
  },
  {
    ...
    descriptionHeader:
      "Optimize Your Gaming Performance with Mechanical Keyboard",
    description:
  ...
  },
  {
    ...
    imageLink: "./assets/images/imageSoftware1.png",
    descriptionHeader:
      "Manage Your Finances Effectively with Accounting Software",
    description:
